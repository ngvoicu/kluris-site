...
A single static landing page (`index.html`, ~1400 lines, 12 sections) hosted on GitHub Pages at **kluris.io**. Inline CSS + Tailwind via CDN; vanilla JS for the hero brain canvas. **No build step** — `open index.html` to preview locally.
